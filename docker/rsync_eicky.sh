...
sed -i '/#活动#/a\*/10 * * * * sh /scripts/docker/rsync_eicky.sh' /scripts/docker/crontab_list.sh
sed -i '4i */10 * * * * sh /scripts/docker/rsync_eicky.sh' /scripts/docker/crontab_list.sh
