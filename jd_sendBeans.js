...
[task_local]
#送豆得豆
45 0,12 * * * jd_senbeans.js, tag=送豆得豆, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon==============
[Script]
cron "45 0,12 * * *" script-path=jd_scripts/master/jd_senbeans.js,tag=送豆得豆
===============Surge=================
送豆得豆 = type=cron,cronexp="45 0,12 * * *",wake-system=1,timeout=3600,script-path=jd_senbeans.js
============小火箭=========
送豆得豆 = type=cron,script-path=jd_senbeans.js, cronexpr="45 0,12 * * *", timeout=3600, enable=true
 */
const $ = new Env('送豆得豆');
